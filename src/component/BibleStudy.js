...
const BibleStudy = () => {
  ...
  return (
    <div>
        <div className='w-screen flex bg-slate-100 flex-col justify-center gap-4 pt-64 px-2 py-36 h-fit pb-36'>
            {data.map((item,index)=>(
        ...
        <div className="fixed top-0 h-60 gap-4 pt-5 bg-slate-100 justify-start flex flex-col w-screen">
           <div className='w-screen flex justify-center items-center'> <div className="text-3xl font-semibold bg-green-950 mb-5 h-14 py-2 w-80 px-3 rounded-xl flex justify-center items-center text-slate-200 text-center">BIBLESTUDY</div>
         </div>         
